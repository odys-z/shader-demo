...
class O3 {
	...
	constructor(options) {
		...
		var p = Object.assign({lon: 104.09856, lat: 30.6765, h: 30},
							options.position);
		var p = Object.assign(p, options.h);
		this.opts.position = p;
		...
		// var campos = osmUtils.rad2cart(pos.lon, pos.lat, R + pos.h);
