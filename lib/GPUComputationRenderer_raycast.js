...
var GPUComputationRenderer = function ( renderer ) {
	...
	var passThruMat = createShaderMaterial( {x: 2, y: 2}, {frag: shfrag}, passThruUniforms );
	...
	this.setVariableDependencies = function ( variable, dependencies ) {
        console.warn('Variable dependencies is a lagacy from yomboprime, not tested - should not working.')
