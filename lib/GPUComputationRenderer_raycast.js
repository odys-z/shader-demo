 ...
 * 3. vertex segments are also the vertices counts. each vertex is rendered a gl.POINTS<br>
 *
...
var GPUComputationRenderer = function ( sizeX, sizeY, renderer ) {
	...
	var passThruShader = createShaderMaterial( {frag: shfrag}, passThruUniforms );
	...
	this.init = function () {
		...
		for ( var i = 0; i < this.variables.length; i ++ ) {
			...
			variable.renderTargets[ 0 ] = this.createRenderTarget( sizeX, sizeY,
                variable.wrapS, variable.wrapT, variable.minFilter, variable.magFilter );
